...
ShelfDESK is a Book Management System built using Flask, a lightweight WSGI web application framework in Python. This project allows users to manage books, members, and transactions in a library.
...
The home page of the BMS_Flask application provides an overview of the book management system. It includes the following sections:
![Navigation](static/naviactiv.png)
- **Welcome Message**: A brief introduction to the book management system.
